...
public abstract class AbstractInterfaceConfig extends AbstractMethodConfig {
    ...
    protected void checkRegistry() {
        ...
        //TODO 调用远程配置文件，加入判断
        registries = checkConfig(registries);
    ...
    /**
     * 检查配置文件，从远端获取配置文件，并对现有的服务进行注册
     * @param registryConfigList
     * @return
     */
    private static List<RegistryConfig> checkConfig(final List<RegistryConfig> registryConfigList) {
//        HttpURLConnection httpURLConnection =
        ...
        try {
            url = new java.net.URL("http://localhost:9999/registry/default");
        ...
        for (RegistryConfig registryConfig : registryConfigList) {
            ...
            System.out.println(registryConfig.getProtocol());
