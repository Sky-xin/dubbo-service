...
public class RegistryProtocol implements Protocol {
    ...
    public void setWhiteList(List<Map<String, String>> whiteList) {
    ...
    private class OverrideListener implements NotifyListener {
        ...
        public void notify(List<URL> urls) {
            System.out.println("notify's urls : "+urls);
            ...
            for (ExporterChangeableWrapper<?> exporter : exporters){
                ...
                if (! originUrl.equals(newUrl)){
                    ...
                    System.out.println("变更的Invoker");
                    System.out.println(originInvoker);
                }
            }
        }
